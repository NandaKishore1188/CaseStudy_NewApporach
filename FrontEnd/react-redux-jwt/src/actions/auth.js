...
export const UpdateProd = (productId,productName, productPrice, productQuantity) => (dispatch) => {
  return ProductService.updateProd(productId,productName, productPrice, productQuantity).then(
    (response) => {
      dispatch({
        type: REGISTER_SUCCESS,
      });
